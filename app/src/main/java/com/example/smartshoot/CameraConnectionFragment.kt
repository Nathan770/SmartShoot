...
class CameraConnectionFragment @SuppressLint("ValidFragment") private constructor(
    ...
    companion object {
        ...
        protected fun chooseOptimalSize(
            ...
            val desiredSize = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                Size(width, height)
            } else {
    ...
    private val captureCallback: CaptureCallback = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    private val stateCallback: CameraDevice.StateCallback = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
